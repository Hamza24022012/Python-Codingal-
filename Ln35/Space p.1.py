...
background=pygame.image.load('Ln35\\background.png')
pygame.display.set_caption("Space Invader")
icon=pygame.image.load('Ln35\\ufo.png')
pygame.display.set_icon(icon)


playerImg=pygame.image.load('Ln35\\player.png')
...
bulletImg=pygame.image.load('Ln35\\bullet.png')
bulletX=0
...
while running:
    ...
    for i in range(num_of_enemies):
        ...
        if isCollision(enemyX[i],enemyY[i],bulletX,bulletY):
            ...
            enemyY[i]=random.randint(ENEMY_START_MIN,ENEMY_START_MAX)
